export DESIGN_NICKNAME = vtpu_pd_full
export DESIGN_NAME = vtpu_pd_full_top
...
export VERILOG_FILES = \
  ...
  $(VTPU_REPO_ROOT)/rtl/physical/vtpu_pd_full_top.sv

export SDC_FILE = $(VTPU_REPO_ROOT)/physical/openroad/designs/sky130hd/vtpu_pd_full/constraint.sdc
...
export MACRO_PLACEMENT_TCL = $(VTPU_REPO_ROOT)/physical/openroad/designs/sky130hd/vtpu_pd_full/macro_placement.tcl
export PDN_TCL = $(VTPU_REPO_ROOT)/physical/openroad/designs/sky130hd/vtpu_pd_full/pdn.tcl
...
export SETUP_SLACK_MARGIN = -200
export HOLD_SLACK_MARGIN = -200

export DIE_AREA = 0 0 30000 44000
export CORE_AREA = 200 200 29800 43800
